...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        setIsNavbarVisible(!isHiddenRoute);
    }, [location.pathname]);

    if (!isNavbarVisible) return null; // Return null if navbar should be hidden
                    ...
                    <li className="nav-item navbar-dropdown dropdown-user dropdown">
                        <a aria-label="dropdown profile avatar" className="nav-link dropdown-toggle hide-arrow" href="#" data-bs-toggle="dropdown">
                            <div className="avatar avatar-online">
                                <img src="https://udayscripts.in/Logo.jpg" className="w-px-40 h-auto rounded-circle" alt="avatar-image" aria-label="Avatar Image" />
                            </div>
                        </a>
                                ...
                                <a aria-label="go to profile" className="dropdown-item" href="#">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            <span className="fw-medium d-block">UdayScripts</span>
